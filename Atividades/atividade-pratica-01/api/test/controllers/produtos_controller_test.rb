...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { doacao_id: @produto.doacao_id, etiqueta: @produto.etiqueta, validade: @produto.validade } }, as: :json
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { doacao_id: @produto.doacao_id, etiqueta: @produto.etiqueta, validade: @produto.validade } }, as: :json
    assert_response :success
  end
